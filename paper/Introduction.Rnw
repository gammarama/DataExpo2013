This work was part of the American Statistical Association's Data Exposition 2013. The dataset comes from the Knight Foundation's `Soul of the Community' project \cite{SOTC}. For this project, the Knight Foundation in conjunction with Gallup collected surveys from 43,000 people over three years in 26 U.S. communities.
