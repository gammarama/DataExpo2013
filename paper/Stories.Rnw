...
<<gp_one, echo=FALSE, fig.cap='Histograms of responses to Education for the five Great Plain communities, and all other communities aggregated.', fig.pos='H', fig.height=3, fig.width=5>>=
