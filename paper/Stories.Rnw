...
sub.df$Education <- as.numeric(sub.df$Education)
...
<<gp_one, echo=FALSE, fig.cap='Histograms of responses to Education for the five Great Plain communities, and all other communities aggregated.', fig.pos='H', fig.height=4, fig.width=6>>=
...
<<gp_two, echo=FALSE, fig.cap='Mean Community Attachment value versus mean Education value. The size of the dots represent the year, while the color represents the community.', fig.pos='H', fig.width=5.5, fig.height=4.5>>=
ggplot(data = ugh) +
...
<<ds_one, echo=FALSE, fig.cap='Responses across the three years for Safety, Social Offerings, and Community Attachment.', fig.pos='H', fig.width=7, fig.height=4.5>>=
...
print(xtable(tbl, digits = c(4, 0, 0, 4), label = "tbl:econ", caption = "The average value for the Economy metric in the five Rust Belt communities"), table.position = "H", include.rownames = FALSE)
@
