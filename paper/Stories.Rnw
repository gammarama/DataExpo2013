...
print(xtable(sub.ddply, digits = c(4, 0, 3), label = "tbl:cce_table", caption = "The average value for the Community Attachment metric in each of the five regions."), table.position = "H", include.rownames = FALSE)
@
