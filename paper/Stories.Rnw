...
print(xtable(sub.df2, digits = 2, label = "tbl:open_table", caption = "Top Five Communities by the Openness Metric. Note that three of the communities are from the West region"), table.position = "H", include.rownames = FALSE)
@
