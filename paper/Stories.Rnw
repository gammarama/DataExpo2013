...
<<west_one, echo=FALSE, fig.cap='2D binned plot of responses for Openness and Community Attachment among the five communities with Very high urbanicity-medium population designations.', fig.pos='H', fig.height=6>>=
...
<<rb_one, echo=FALSE, fig.cap='Density of responses for Economy in Rust Belt communities over each of the three years.', fig.pos='H', warning=FALSE>>=
