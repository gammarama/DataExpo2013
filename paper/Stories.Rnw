...
\caption{\label{fig:greatplains_1} Depiction of the first two steps taken in CommuniD3 with regards to the Great Plains region.}
\end{figure}
...
\caption{\label{fig:greatplains_2} The third and fourth steps taken in the exploration of the Great Plains region using CommuniD3.}
\end{figure}
...
\caption{\label{fig:greatplains_3} The final steps taken in CommuniD3 with regards to the Great Plains region. These steps led to the discovery of Education as a particular driver of Community Attachment in these communities.}
\end{figure}
