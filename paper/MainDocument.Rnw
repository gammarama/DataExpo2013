...
opts_chunk$set(concordance=TRUE, fig.align = "center")
...
plot2 <- qplot(QSB, CCE, stat = "identity", geom = "bar", data = subset(clean.all.comb, QSB %in% c("St. Paul, MN", "Very high urbanicity-large population", "Great Plains", "All Cities")), fill = QSB, alpha = ispaul) +
    ...
    theme_bw() +
    theme(legend.position = "off", axis.text.x = element_text(angle = -45, vjust = 0.9, hjust = 0.1), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), aspect.ratio = 1)
...
plot3 <- ggplot() +
    ...
    theme_bw() +
    theme(legend.position = "off", axis.text.x = element_text(angle = -45, vjust = 0.9, hjust = 0.1), panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
plot4 <- qplot(QSB, EDUCATIO, geom = "point", colour = ispaul, data = clean.all.city, size = ispaul) +
    ...
    ylab("Education") +
    theme_bw() +
    theme(legend.position = "off", panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
ggsave(filename = "plot2.pdf", plot = plot2, width=3.61, height=3.74, scale = 2)
ggsave(filename = "plot3.pdf", plot = plot3, width=3.61, height=3.74, scale = 2)
ggsave(filename = "plot4.pdf", plot = plot4, width=3.61, height=3.74, scale = 2)
ggsave(filename = "plot5.pdf", plot = plot5, width=3.61, height=3.74, scale = 2)
ggsave(filename = "plot6.pdf", plot = plot6, width=3.61, height=3.74, scale = 2)
@
