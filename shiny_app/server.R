...
shinyServer(function(input, output) {
    data <- function() {
        ...
        clean.all.city <- ddply(clean.all, .(QSB), summarise, THRIVEIND = mean(THRIVEIND, na.rm = TRUE), AESTHETI = mean(AESTHETI, na.rm = TRUE), ECONOMY = mean(ECONOMY, na.rm = TRUE), INVOLVEM = mean(INVOLVEM, na.rm = TRUE), TOTALRESP = length(GENDER))
        clean.2008.city <- ddply(subset(clean.all, source == "sotc08"), .(QSB), summarise, THRIVEIND = mean(THRIVEIND, na.rm = TRUE), AESTHETI = mean(AESTHETI, na.rm = TRUE), ECONOMY = mean(ECONOMY, na.rm = TRUE), INVOLVEM = mean(INVOLVEM, na.rm = TRUE), TOTALRESP = length(GENDER))
        clean.2009.city <- ddply(subset(clean.all, source == "sotc09"), .(QSB), summarise, THRIVEIND = mean(THRIVEIND, na.rm = TRUE), AESTHETI = mean(AESTHETI, na.rm = TRUE), ECONOMY = mean(ECONOMY, na.rm = TRUE), INVOLVEM = mean(INVOLVEM, na.rm = TRUE), TOTALRESP = length(GENDER))
        clean.2010.city <- ddply(subset(clean.all, source == "sotc10"), .(QSB), summarise, THRIVEIND = mean(THRIVEIND, na.rm = TRUE), AESTHETI = mean(AESTHETI, na.rm = TRUE), ECONOMY = mean(ECONOMY, na.rm = TRUE), INVOLVEM = mean(INVOLVEM, na.rm = TRUE), TOTALRESP = length(GENDER))
